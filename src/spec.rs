...
macro_rules! encoding_struct {
    ...
    struct $name:ident {
        ...
        impl<'a> $crate::Field<'a> for $name {
            unsafe fn read(buffer: &'a [u8],
                            from: $crate::Offset,
                            to: $crate::Offset) -> Self {
                let vec: Vec<u8> = $crate::Field::read(buffer, from, to);
                unimplemented!();
            ...
            fn write(&self,
                            ...
                            from: $crate::Offset,
                            to: $crate::Offset) {
                $crate::Field::write(&self.raw, buffer, from, to);
            }

            #[allow(unused_variables)]
            #[allow(unused_comparisons)]
            fn check(buffer: &'a [u8],
                        from_st_val: $crate::CheckedOffset,
                        to_st_val: $crate::CheckedOffset,
                        latest_segment: $crate::CheckedOffset)
                -> $crate::Result
            {
                let latest_segment_origin = <&[u8] as $crate::Field>::check(
                    buffer, from_st_val, to_st_val, latest_segment)?;
                let vec: &[u8] = unsafe{ $crate::Field::read(
                    buffer,
                    from_st_val.unchecked_offset(),
                    to_st_val.unchecked_offset())};
                let latest_segment: $crate::CheckedOffset =
                    ($body as $crate::Offset).into();

                if vec.len() < $body {
                    return Err($crate::Error::UnexpectedlyShortPayload{
                        actual_size: vec.len() as $crate::Offset,
                        minimum_size: $body as $crate::Offset
                    })
                }

                $(
                let latest_segment = <$field_type as $crate::Field>::check(&vec,
                                                                        $from.into(),
                                                                        $to.into(),
                                                                        latest_segment)?;
                )*
        ...
        impl $name {
            ...
            pub fn new($($field_name: $field_type,)*) -> $name {
                ...
                $($crate::Field::write(&$field_name, &mut buf, $from, $to);)*
                $name { raw: buf }
            }
        ...
        impl $crate::serialize::json::ExonumJson for $name {
            #[allow(unused_variables)]
            fn deserialize_field<B> (value: &$crate::serialize::json::reexport::Value,
                ...
                where B: $crate::serialize::WriteBufferWrapper
            {
            ...
            fn serialize_field(&self)
                -> Result<$crate::serialize::json::reexport::Value,
                          Box<::std::error::Error>>
            {
                use $crate::serialize::json::reexport::Value;
                let mut map = $crate::serialize::json::reexport::Map::new();
                $(
        ...
        impl $crate::serialize::json::ExonumJsonDeserialize for $name {
            ...
            fn deserialize(value: &$crate::serialize::json::reexport::Value)
                ...
                use $crate::serialize::json::ExonumJson as ExonumJson;
                let mut buf = vec![0; $body];
        ...
        impl<'de> $crate::serialize::reexport::Deserialize<'de> for $name {
            fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
                where D: $crate::serialize::reexport::Deserializer<'de>
            {
                use $crate::serialize::json::reexport::Value;
                use $crate::serialize::reexport::{DeError, Deserialize};
                let value = <Value as Deserialize>::deserialize(deserializer)?;
                <Self as $crate::serialize::json::ExonumJsonDeserialize>::deserialize(
                    &value).map_err(|_| D::Error::custom("Can not deserialize value."))
            }
        }

        impl $crate::serialize::reexport::Serialize for $name {
            fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
                where S: $crate::serialize::reexport::Serializer
            {
                use $crate::serialize::reexport::SerError;
                use $crate::serialize::json::ExonumJson;
